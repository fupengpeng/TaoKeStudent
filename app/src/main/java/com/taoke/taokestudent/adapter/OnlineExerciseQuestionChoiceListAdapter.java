 ...
 * 在线做题题目选择列表的Adapter
 */
public class OnlineExerciseQuestionChoiceListAdapter extends BaseAdapter<String> {
     ...
     * @param data
     */
    public OnlineExerciseQuestionChoiceListAdapter(Context context, List<String> data) {
        super(context, data);
    }
